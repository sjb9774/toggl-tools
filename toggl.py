...
if __name__ == "__main__":
    ...
    start_parser.add_argument("--delete", action="store_true", help="Deletes the currently running entry and starts a new one based on your configuration.")
    stop_parser.add_argument("--delete", action="store_true", help="Stops and deletes the currently running timer.")
